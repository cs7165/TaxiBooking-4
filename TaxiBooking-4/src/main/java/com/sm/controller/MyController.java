...
import com.sm.service.BookingFormService;
import com.sm.service.ContactFormService;
...
public class MyController {
	...
	public String indexView(HttpServletRequest req,Model m) {
	...
	public String contactForm(@Valid @ModelAttribute ContactForm contactForm,BindingResult
			bindingResult, Model m,RedirectAttributes redirectAttributes) {
		...
		ContactFormEntity result = contactFormService.saveContactFormService(contactForm);
		if(result!=null) {
	...
	public String saveBookingForm(@Valid @ModelAttribute BookingForm bookingForm,
